...
{
    public class ValidateIdentityContext : BaseContext<BasicAuthenticationOptions>
    {
        public ValidateIdentityContext(IOwinContext context, AuthenticationTicket ticket, BasicAuthenticationOptions options)
